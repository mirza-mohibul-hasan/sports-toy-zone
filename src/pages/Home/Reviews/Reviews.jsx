...
const ContactUs = () => {
    ...
    return (
        <section className="my-8 w-11/12 mx-auto mt-10">
            ...
            <div className='lg:flex gap-5'>
                ...
                <div className="p-5 mt-5 lg:mt-0 lg:p-20 rounded lg:w-1/3  bg-[#5e9bcc98]" data-aos="zoom-out">
                    <h1 className="text-2xl text-center lg:-mt-7 mb-5 text-white font bold">Message Us</h1>
